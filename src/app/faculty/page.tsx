 ...
 return(
  <div className="bg-slate-50">
    <div className="relative hidden md:block bg-[url('/faculty.jpg')] bg-cover brightness-75 bg-center xl:h-96">
            <div className="absolute hidden md:block inset-0 item-center justify-center">
                <h1 className="text-white text-5xl mt-24  font-bold  bg-opacity-50 p-4 rounded">
                Meet Our Senior Faculty <br /> 
                <h2 className="text-2xl text-black hidden md:block">Hamdard Intermediate College ,Faculty</h2>
                </h1>
                
                </div>
            </div>
            <h1 className="sm:text-4xl sm:ml-96 mt-11"><b>Our Faculty</b></h1>
   <section className="sm:grid grid-cols-3 my-8 sm:ml-9">
